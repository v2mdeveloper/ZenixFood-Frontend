          ...
          <div className="bg-purple-50 p-6 rounded-3xl border border-purple-200 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.plan} onChange={e => setForm({...form, plan: e.target.value})} className="w-full bg-white border border-purple-300 rounded-xl p-3.5 text-sm text-slate-900 focus:outline-none focus:border-purple-500 font-bold shadow-sm cursor-pointer">
              ...
              <div>
                ...
                <input type="number" step="0.01" required value={form.monthlyFee} onChange={e => setForm({...form, monthlyFee: e.target.value})} placeholder="Ex: 149.90" className="w-full bg-white border border-purple-300 rounded-xl p-3.5 text-sm text-slate-900 focus:outline-none focus:border-purple-500 font-bold shadow-sm text-purple-700" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div><label className="text-[10px] font-black text-slate-500 uppercase block mb-1">UF</label><input type="text" required maxLength={2} value={form.state} onChange={e => setForm({...form, state: e.target.value.toUpperCase()})} placeholder="SP" className="w-full bg-white border border-slate-300 rounded-xl p-3.5 text-sm text-slate-900 focus:outline-none focus:border-emerald-500 uppercase font-mono text-center shadow-sm" /></div>
              </div>
            </div>
          </div>

          <div className="pt-4 flex gap-4">
            <button type="button" onClick={() => router.back()} className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold py-4 rounded-2xl cursor-pointer transition-colors border border-slate-300">Voltar</button>
