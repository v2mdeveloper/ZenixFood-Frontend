...
export default function PromotionsTab({
  ...
  return (
    <>
      ...
      {/* 🔥 MODAL UPSELL MOVIDO PARA FORA DO MAIN PARA EVITAR CORTES DE OVERFLOW/ANIMATION */}
      {showUpsellModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[9999] flex justify-center items-start p-4 md:p-8 overflow-y-auto">
