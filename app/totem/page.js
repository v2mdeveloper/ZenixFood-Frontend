  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center p-6 text-center selection:bg-amber-500 selection:text-black font-sans">
      <div className="bg-[#121212] border border-amber-500/30 p-10 rounded-[3rem] w-full max-w-lg shadow-2xl relative overflow-hidden">
        ...
        <p className="text-zinc-400 font-bold mb-8">Zenix • Plataforma de Autoatendimento</p>

        <div className="bg-black/50 border border-white/10 p-6 rounded-2xl mb-8 text-left">
           <h3 className="text-amber-500 font-black text-sm uppercase tracking-widest mb-3">Como configurar este terminal:</h3>
           <ol className="text-zinc-300 text-sm space-y-3 font-medium">
              ...
              <li><strong className="text-white">3.</strong> Confirme a instalação do software.</li>
              <li><strong className="text-white">4.</strong> Vá para a tela inicial do dispositivo, abra o ícone <strong className="text-amber-400">"Zenix Totem"</strong> e inicie as operações!</li>
           </ol>
        </div>

        <button 
          onClick={() => router.push('/?totem=true')} 
          className="w-full bg-amber-500 hover:bg-amber-400 text-black font-black py-4 rounded-xl text-lg transition-all shadow-[0_0_20px_rgba(245,158,11,0.2)] cursor-pointer"
        >
